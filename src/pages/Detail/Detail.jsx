...
const Detail = () => {
    ...
    //             // Lấy dữ liệu thành công thì đưa vô nơi lưu trữ tạm thời của sản phảm
    //             setProduct( {id: dataFireStore.id, ...dataFireStore.data()});
    ...
    return (
        ...
        <div>Đây là trang mô tả sản phẩm</div>
